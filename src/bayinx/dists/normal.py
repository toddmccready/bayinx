...
## Typing
from jaxtyping import Real, Array, ArrayLike
...
# MARK: Functions ----
def prob(x: Real[ArrayLike, "..."],
         mu: Real[ArrayLike, "..."],
         sigma: Real[ArrayLike, "..."]) -> Real[Array, "..."]:
    """
